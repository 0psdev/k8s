...
# Joint worker
kubeadm join ct01.home.local:6443 --token TTTTT --discovery-token-ca-cert-hash sha256:HHHHH *** TTTT is value, HHHH is value after intial you can seen or can create new
